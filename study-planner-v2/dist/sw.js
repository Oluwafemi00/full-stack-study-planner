...
class B {
  ...
  async cachePut(e, t) {
    ...
    const { cacheName: c, matchOptions: i } = this._strategy,
      ...
      g = h ? await A(o, n.clone(), ["__WB_REVISION__"], i) : null;
    try {
  ...
  async doneWaiting() {
    for (; this._extendLifetimePromises.length; ) {
      const e = this._extendLifetimePromises.splice(0),
        s = (await Promise.allSettled(e)).find((n) => n.status === "rejected");
      if (s) throw s.reason;
    }
  }
  destroy() {
...
let y;
const z = () => (
  y || ((y = new Q()), y.addFetchListener(), y.addCacheListener()),
  y
);
function J(a, e, t) {
  let s;
...
const te = "-precache-",
  se = async (a, e = te) => {
    const s = (await self.caches.keys()).filter(
      (n) => n.includes(e) && n.includes(self.registration.scope) && n !== a,
    );
...
re([
  { revision: "19d0e8ea9b4201806913f183d23821af", url: "index.html" },
  { revision: "7f957c2b88ba7ae6493efdcb1686fca9", url: "icon-512.png" },
  { revision: "7ddcc8cb010f8921730d3de9ae13f507", url: "icon-192.png" },
  { revision: "a1345cdd7993305e9b055a62da872037", url: "favicon.svg" },
  { revision: null, url: "assets/workbox-window.prod.es5-vqzQaGvo.js" },
  { revision: null, url: "assets/virtual_pwa-register-FyStW-ZS.js" },
  { revision: null, url: "assets/index-CBTh51p2.css" },
  { revision: null, url: "assets/index-BDiVwUx2.js" },
  { revision: "7ddcc8cb010f8921730d3de9ae13f507", url: "icon-192.png" },
  { revision: "7f957c2b88ba7ae6493efdcb1686fca9", url: "icon-512.png" },
  { revision: "80757bb16fe4b79ea432784552f828eb", url: "manifest.webmanifest" },
]);
ae();
